...
MODES = {
    ...
    "nature":    ("Nature",     "Birdsong, wind, rain, and forest textures"),
...
MODE_TAGS = {
    ...
    "nature":     "nature birds birdsong wind rain forest organic field-recording ambient",
...
GLORB_INFO = (
    ...
    "a browser-based generative audio synthesiser by Matteo Bassi.\n\n"
    "Every sound is built from scratch in real-time — no samples, no loops, "
    "pure mathematics. The synthesis engine runs on NumPy and SciPy in Python "
    "at 44 100 Hz stereo. Techniques used include additive synthesis, FM synthesis, "
    "subtractive synthesis (Butterworth filters), granular synthesis, physical modelling, "
    "Karplus-Strong string synthesis, and noise shaping.\n\n"
    "Three global knobs shape every mode: Energy (event density), "
    "Brightness (frequency balance), and Chaos (drive and pitch wobble)."
)
...
def main():
    ...
    for i, mode in enumerate(selected, 1):
        ...
        rows.append({
            ...
            "name": f"{label} — Generative Sound by Glorb",
